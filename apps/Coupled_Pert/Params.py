...
class Params(object):
    ...
    def __init__(self,app,xcpu,ycpu,start_date,end_date,nrrec=-1,cicecpu=0,restart=False):
	    ...
	    self.ATMFORCPATH="/global/work/sfr009/Arctic-20km/ERA/"
	    self.OCNFORCPATH="/global/work/sfr009/Arctic-20km/openBering/"
            ...
            ['STASTEP',str(240*3600/int(self.DELTAT))],
            ['INFOSTEP', str(240*3600/int(self.DELTAT))],
            ['HISSTEPP', str(240*3600/int(self.DELTAT))],
            ...
            ['ATMDIR',self.ATMFORCPATH+"/AN_2009_unlim.nc | \n"+self.ATMFORCPATH+"/AN_2010_unlim_pert.nc \ \n"+self.ATMFORCPATH+"/FC_2009_unlim.nc | \n"+self.ATMFORCPATH+"/FC_2010_unlim_pert.nc"],
            ...
            ['ATMDIR',self.ATMFORCPATH+"/AN_1997_unlim.nc \ "+self.ATMFORCPATH+"/FC_1997_unlim.nc"],
